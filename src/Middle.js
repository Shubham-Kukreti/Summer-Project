       ...
       <div id="carouselExampleInterval" class="carousel slide slidingImg" data-ride="carousel">
        ...
        <div class="carousel-inner sliding">
          <div class="carousel-item active" data-interval="3000">
            <img src={require('./Movie/m2.png')} class="d-block w-100" />
           </div>
    
           <div class="carousel-item" data-interval="2000">
            <img src={require('./Movie/m3.png')} class="d-block w-100"  />
          </div>
    
          <div class="carousel-item" data-interval="2000">
            <img src={require('./Movie/m4.png')} class="d-block w-100"  />
          </div>

          <div class="carousel-item">
            <img src={require('./Movie/m1.png')} class="d-block w-100"  />
          </div>
        </div>
